...
model = pickle.load(open('models/Sidhaarth_211AI035_Savedmodel.pkl', 'rb'))
...
@application.route('/')
def home():
    return render_template('Sidhaarth_211AI035_Frontend.html')
...
def predict():
    ...
    return render_template('Sidhaarth_211AI035_Frontend.html', prediction_text='Danceability is: {}'.format(prediction[0]))
